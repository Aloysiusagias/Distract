...
const menuToko = () => {
    const renderItem = ({item, index}) => {
        return (
          <TouchableOpacity style={styles.containerItem} onPress={() => navigation.navigate('tambahBarang')}>
            <View
                    ...
                    alignContent: "space-around",
                        ...
                        <View
                            style={{
                                ...
                                <Text style={styles.teksAlamat}>Jl. Ks Tubun, Kebayan 3, Sragen Kulon,Kec. Sragen, Kabupaten Sragen, Jawa Tengah</Text>
              ...
              <View
                style={{
                    ...
                    alignContent: "space-around",
                            ...
                            <TouchableOpacity activeOpacity={0.5} onPress={() => navigation.navigate('keranjang')} style={styles.TouchableOpacityStyleTambah} >
